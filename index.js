(function () {
    ...
    window.edGetPublicKey = getPublicKey;
    window.edGetPublicKeyAsync = getPublicKeyAsync;
    window.edSign = sign;
    window.edVerify = verify;
    window.edSignAsync = signAsync;
    window.edVerifyAsync = verifyAsync;
    window.edCURVE = CURVE;
    window.edEtc = etc;
    window.edUtils = utils;
    window.ExtendedPoint = Point;
})();